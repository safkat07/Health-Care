    ...
    return (
        <ContentWrapper className={"py-28"}>
            <div className="flex items-center  w-full  ">
                <div className="flex-1 flex xl:gap-y-7 gap-y-5 flex-col justify-start items-start">
                    <SmallHeadingText className={"bg-[#FFFFF5] "} smallTitle={"Who are we"} />
                ...
                <div className="flex-1 w-full ">
                    <div className="relative">
                        ...
                        <div className="w-[300px] xl:h-[40%] h-1/2 bg-[#343268] p-5 text-white rounded-3xl absolute top-[70%] -left-20">
